...
const AboutPage = () => {
                ...
                <Container>
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-lg mb-4 text-justify">
                                My name is Ayush Srivastava, and I'm currently pursuing Computer Science at Delhi Technological University (formerly Delhi College of Engineering). As a pre-final year student, I have a passion for technology and web development.
                            </p>
                            <p className="text-lg mb-4 text-justify">
    ...
    <div className="max-w-3xl w-full">
        ...
        <ul className="flex justify-center space-x-4">
            <li>
                <a href="https://www.instagram.com/ayushh_srivastava16/" className="flex items-center text-indigo-400 hover:text-indigo-300">
            ...
            <li>
                <a href="https://www.linkedin.com/in/ayush-srivastava-84173b253/" className="flex items-center text-indigo-400 hover:text-indigo-300">
            ...
            <li>
                <a href="https://github.com/srivastavaayush1611" className="flex items-center text-indigo-400 hover:text-indigo-300">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" className="mr-2">
